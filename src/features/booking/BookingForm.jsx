      ...
      <Card>
        ...
        {booking.flight ? (
          <Row>
            ...
            <div>Depart: {new Date(booking.flight.depart).toLocaleString()}</div>
            <div>Arrive: {new Date(booking.flight.arrive).toLocaleString()}</div>
        ...
        {booking.passengers.map((p) => (
          <Row key={p.id}>
            ...
            <Input type="date" value={p.dob || ''} onChange={(e)=>dispatch(updatePassenger({id:p.id, changes:{dob: e.target.value}}))} />
